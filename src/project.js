...
if (navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/iPhone/i)) {
    document.body.getElementsByTagName('canvas')[0].addEventListener('touchstart', unlockmyaudios, false);
 }
 else {
    document.body.addEventListener('click', unlockmyaudios, false);
 }
function unlockmyaudios(e) {
    e.preventDefault();
    for(var i = 0; i < 9; i++) {
        console.log("unlocking audio " + i);
        var audio = document.getElementById("cjiao" + i);
        audio.play()
        audio.pause()
        audio.currentTime = 0
    }
    document.body.removeEventListener('click', unlockmyaudios);
    document.body.getElementsByTagName('canvas')[0].removeEventListener('touchstart', unlockmyaudios);
}
            ...
            p = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    this.canClick && (this.moreGameBtn.off(cc.Node.EventType.TOUCH_START, this.OnClickMoreGame, this), this.canClick = !1, this.moreGameBtn.runAction(cc.sequence(cc.scaleTo(.1, 1.1), cc.scaleTo(.1, 1))), this.scheduleOnce(function() {
                        window.location.href = "https://space.bilibili.com/67141"
                    }, .15))
                }, t.prototype.GetContentByScore = function(e) {
                    var t = Math.ceil(e / 1500 * 94);
                    t > 94 && (t = 94);
                    var n = 5 + t;
                    return "你的C瓜大过了全球" + n + "%的玩家", ["你的C瓜大过了全球" + n + "%的玩家", "擊敗了全球" + n + "%的玩家！", "Beat " + n + " % of global players", "전 세계" + n + "% 의 유 저 를 이 겼 습 니 다"][i.default.returnCurrentLanType() - 1]
        ...
        var a = e("../common/PlayerInfo"),
            ...
            m = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    /*
                    console.log("createFruitSui");
                    var sound = document.createElement("audio");
                    if(e >= 0 && e <= 8) {
                        sound.src = "http://cgua.bee-6.com/res/" + e + ".mp3";
                    }
                    else {
                        // sound.src = "res/destroy.mp3";
                        // sound.src = "http://cgua.bee-6.com/res/destroy.mp3";
                    ...
                    sound.play();
                    console.log("Fruit number is: " + e);
                    */
                    if(e >= 0 && e <= 8) {
                        var sound = document.getElementById("cjiao" + e);
                        if(sound) sound.play();
                    }
                    else {
                        u.default.Instance.Play(3, !1, .5), u.default.Instance.Play(6, !1, .3);
        ...
        var a = e("../common/PlayerInfo"),
            ...
            h = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    // b.default.Instance.createOneFruit(9)
